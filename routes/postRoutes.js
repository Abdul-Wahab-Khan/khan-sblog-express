...
router.route("/like").post(tokenValidator, postController.like);

router.route("/unlike").post(tokenValidator, postController.unlike);

router.route("/isliked").post(tokenValidator, postController.isLiked);
